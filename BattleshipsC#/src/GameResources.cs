...
public static class GameResources
{
	...
	private static void ShowLoadingScreen()
	{
		...
		_LoadingFont = SwinGame.LoadFont(SwinGame.PathToResource("arial.ttf", ResourceKind.FontResource), 22);
	...
	private static void ShowMessage(string message, int number)
	{
		...
		SwinGame.DrawTextLines(message, Color.White, Color.Green, _LoadingFont, FontAlignment.AlignCenter, TX, TY, TW, TH);
